...
const generateSequence = (length: any) => Array.from({ length }, (_, index) => index + 1);

const deterministicShuffle = (array: any, seed: any) => {
...
const getDeterministicRandom = (tokenId: any) => {
